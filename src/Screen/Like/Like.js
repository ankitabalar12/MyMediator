                ...
                {is_select == '1' ? (<View>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {todaydetails_data.length > 0 ? (
                            ...
                            <Text style={[styles.adstext2,{alignSelf:'center'}]}>No ads todat details</Text>
                        )}
                ...
                <View style={styles.backgroundview}>
                  ...
                  <View style={styles.flexrowchoose}>
                    <View style={styles.oneflexchooview}>
                        ...
                        <Text style={[styles.byproty,{color:selectedoption === 1 ? "#000" : '#000', fontWeight:selectedoption === 1 ? '900' : '400' }]}>By Propert Type</Text>
                        </TouchableOpacity>
                        <View style={styles.borwview}></View>
                        <TouchableOpacity onPress={()=>{
                            selectOption(2)
                        }}>
                        <Text style={[styles.byproty,{color:selectedoption === 2 ? "#000" : '#000', fontWeight:selectedoption === 2 ? '900' :'500' }]}>By Bedrooms</Text>
                        </TouchableOpacity>
                        <View style={styles.borwview}></View>
                        <TouchableOpacity onPress={()=>{
                            selectOption(3)
                        }}>
                        <Text style={[styles.byproty,{color:selectedoption === 3 ? "#000" : '#000', fontWeight:selectedoption === 3 ? '900' :'500' }]}>By Price Per SQ . FT</Text>
                        </TouchableOpacity>
                        <View style={styles.borwview}></View>
                        <TouchableOpacity onPress={()=>{
                            selectOption(4)
                        }}>
                        <Text style={[styles.byproty,{color:selectedoption === 4 ? "#000" : '#000', fontWeight:selectedoption === 4 ? '900' :'500' }]}>By Furnishing</Text>
                        </TouchableOpacity>
                        <View style={styles.borwview}></View>
                        <TouchableOpacity onPress={()=>{
                            selectOption(5)
                        }}>
                        <Text style={[styles.byproty,{color:selectedoption === 5 ? "#000" : '#000', fontWeight:selectedoption === 5 ? '900' :'500' }]}>By Bathroom</Text>
                        </TouchableOpacity>
                        <View style={styles.borwview}></View>
                        <TouchableOpacity onPress={()=>{
                            selectOption(6)
                        }}>
                        <Text style={[styles.byproty,{color:selectedoption === 6 ? "#000" : '#000', fontWeight:selectedoption === 6 ? '900' :'500' }]}>By Construction Status</Text>
                        </TouchableOpacity>
                        <View style={styles.borwview}></View>
                        <TouchableOpacity onPress={()=>{
                            selectOption(7)
                        }}>
                        <Text style={[styles.byproty,{color:selectedoption === 7 ? "#000" : '#000', fontWeight:selectedoption === 7 ? '900' :'500' }]}>By Listed by</Text>
                        </TouchableOpacity>
                        <View style={styles.borwview}></View>
                        <TouchableOpacity onPress={()=>{
                            selectOption(8)
                        }}>
                        <Text style={[styles.byproty,{color:selectedoption === 8 ? "#000" : '#000', fontWeight:selectedoption === 8 ? '900' :'500' }]}>By Super Buildup Area</Text>
                        </TouchableOpacity>
                        <View style={styles.borwview}></View>
                        <TouchableOpacity onPress={()=>{
                            selectOption(9)
                        }}>
                        <Text style={[styles.byproty,{color:selectedoption === 9 ? "#000" : '#000', fontWeight:selectedoption === 9 ? '900' :'500' }]}>Change Sort</Text>
                        </TouchableOpacity>
