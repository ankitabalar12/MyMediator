...
import { electronicsenquiryapi } from '../../../APICall'
import { ActivityIndicator } from 'react-native'


const ElictronicEnquiry = ({route}) => {
    ...
    const electronics_id = route?.params;
    console.log('electronics_id------------', electronics_id)
    useEffect(() => {
    ...
    const Electronicsenquiry = async () => {
        ...
        const data = {
            user_id:Id,
            property_id:electronics_id.electronics_id,
            type:2, 
            name:name,
         ...
         console.log('data -------------',data)
          const res = await electronicsenquiryapi(global.url + 'enquiry ', data);
          console.log('res ><>><', res)
...
export default ElictronicEnquiry
