...
import { propertyenquiryapi } from '../../../APICall'
import { ActivityIndicator } from 'react-native'


const PropertyEnquiry = ({route}) => {
    ...
    const propertyenquiry = async () => {
        ...
        const data = {
         ...
         console.log('data -------------',data)
          const res = await propertyenquiryapi(global.url + 'enquiry ', data);
          console.log('res ><>><', res)
